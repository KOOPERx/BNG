...
client.discordTogether = new DiscordTogether(client);
	...
	.setTitle('ขอโทษนะนายโดนระงับการใช้บอทนี้ขอโทษทีนะถ้าอยากโดนปลดต้องทักไปหาผู้พัฒนา BNG Studio#7414 หรือ โฟส | ก๊อด#5450')
    .setColor("RED"));
    ...
    .setAuthor('BNG', client.user.avatarURL())
